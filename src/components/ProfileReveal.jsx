...
const ContentReveal = () => {
  const profiles = {
    Profile1: {
        img_url: '/section-imgs/profile1.png',
        name: 'Tony Culliney',
    ...
    Profile2: {
        img_url: '/section-imgs/profile2.png',
        name: 'Thomas Bendall',
    ...
    Profile3: {
        img_url: '/section-imgs/profile3.png',
        name: 'James Frankham',
    ...
    Profile4: {
        img_url: '/section-imgs/profile4.png',
        name: 'Peter Hanning',
        position: 'Board of Trustees memeber',
    ...
    Profile5: {
        img_url: '/section-imgs/profile5.png',
